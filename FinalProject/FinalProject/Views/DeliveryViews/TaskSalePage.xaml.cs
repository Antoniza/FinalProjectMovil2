...
namespace FinalProject.Views.DeliveryViews
{
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class TaskSalePage : ContentPage
    {
        Sales sale;
        public TaskSalePage(Sales _sale)
        {
            InitializeComponent();
        ...
        protected override void OnAppearing()
        {
            ...
            var ShoppingList = JsonConvert.DeserializeObject<List<Shopping>>(sale.ShoppingCar);
        ...
        private async void BackButton_Clicked(object sender, EventArgs e)
        {
            ...
            bool res = await SalesProvider.UpdateState(updateSale);
